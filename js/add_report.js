jQuery(document).ready(function ($)  {
    ...
    $('body').on('click', '.add_report_submit', function() {
        ...
        $price = $('.sto_report').children('input[name="price"]').val();
       ...
       $data = 'work_id='+$work_id+'&url_video='+$url_video+'&text='+$text+'&comment='+$comment+'&servises='+$servises+'&uid='+$uid+'&price='+$price;
        $.ajax({
            type: 'POST',
